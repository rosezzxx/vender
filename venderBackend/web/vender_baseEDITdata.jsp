<%-- 
    Document   : vender_baseEDITdata
    Created on : 2019/7/11, 下午 02:36:48
    Author     : user
--%>
...
<%    /*-------------- pageInit.jsp 宣告之公用變數如下 -----------------------*/
 ...
 /*-------------------------------------------------------------------*/
    ...
    if (editMode.equals("D")) {
        funcTitle = "刪除";
        commSQL = "DELETE FROM  prod_base ";
        commSQL = commSQL + "WHERE  prodID =  " + DBcomic.psString(prodID) + " ;";    // 刪除所有的類別
        ...
        commSQL = "UPDATE prod_base SET inventory=" + DBcomic.psString(inventory);
        commSQL = commSQL + " WHERE  prodID=" + DBcomic.psString(prodID);
