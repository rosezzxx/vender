...
<%    /*-------------- pageInit.jsp 宣告之公用變數如下 -----------------------*/
 ...
 /*-------------------------------------------------------------------*/
    ...
    /*
        ...
        {
              SaveMessage = "會員資料重複輸入 !!";
        } 
     */
    commSQL = "UPDATE vender SET email=" + DBcomic.psString(Email) + ", ";
    commSQL = commSQL + "password=" + DBcomic.psString(Password) + ", ";
    commSQL = commSQL + "name=" + DBcomic.psString(Name) + ", ";
    commSQL = commSQL + "mobilno=" + DBcomic.psString(Mobilno) + ", ";
    commSQL = commSQL + "areaNo=" + DBcomic.psString(AreaNo) + ", ";
    commSQL = commSQL + "address=" + DBcomic.psString(Address) + ", ";
    commSQL = commSQL + "uniformNo=" + DBcomic.psString(UniformNo) + ", ";
    commSQL = commSQL + "companyName=" + DBcomic.psString(CompanyName) + ",  ";
    commSQL = commSQL + "companyType=" + DBcomic.psString(CompanyType) + "  ";
    commSQL = commSQL + "WHERE  pdVenderID=" + DBcomic.psString(pdVenderID);
